...
const doubleXpPotionImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_cvohg3';
const streakShieldImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_erjhwt';
const motivationFairyImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_mw5c1v';
const pastelButterflyWingsImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_m8rhfd';
const goldenCrystalCrownImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_aokoxq';
const sakuraBlossomOutfitImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_aweuab';
const pinkStarWandImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_pvzpjj';
const crystalLuckElixirImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_scj44o';
const starfallDiceImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_qemis7';
const phoenixFeatherImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_pxzyju';
const magicalFairyCompanionImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_vuo5zk';
const moonlightFairyWingsImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_t63u0n';
const celestialPrincessGownImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_wl2rx5';
const rosePetalMagicImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_yat96j';
const angelHaloEffectImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_zztpgn';
const goldenSunflowerHairpinImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_etmmx2';
const bloomBazaarHeaderImg = 'https://res.cloudinary.com/dudunom7x/image/upload/screen_gtimmr';
